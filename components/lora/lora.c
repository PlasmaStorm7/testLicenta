...
#define GPIO_INPUT_PINMASK             (1ULL<<CONFIG_LORA_DIO0_GPIO)
...
/**
 * Sets the radio transceiver in transmit mode.
 * FIFO will be transmitted.
 */
 ...
 * Channel activity will be detected
 */
void lora_CAD(void)
{
...
/**
 * Configure power level for transmission with PA boost
...
lora_init(int current_spi_host)
{
   ...
   io_conf.pin_bit_mask = GPIO_OUTPUT_PINMASK;//((1ULL<<CONFIG_LORA_RST_GPIO)|(1ULL<<CONFIG_LORA_CS_GPIO))
   ...
   io_conf.pin_bit_mask = GPIO_INPUT_PINMASK;//(1ULL<<CONFIG_LORA_DIO0_GPIO)
   //set as input mode
